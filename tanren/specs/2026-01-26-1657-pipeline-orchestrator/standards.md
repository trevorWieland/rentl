# Standards for Pipeline Orchestrator
...
- Examples: `run_started`, `phase_completed`, `translation_finished`
...
- **What's next:** Recovery action or next step (retrying, user intervention needed)
