...
Critique and score completed spec implementations across a 5-pronged rubric plus standards adherence. Produces `audit.md` in the spec folder and logs decisions to GitHub.
...
1. A completed spec folder exists in `agent-os/specs/` with `plan.md`, `shape.md`, and `standards.md`
...
Only ask per-item when exceptions are needed.
