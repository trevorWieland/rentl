...
|-------|------|----------|-------------|
| `run_id` | `RunId` | yes | Run identifier |
| `phase` | `PhaseName` | yes | Always `"context"` |
...
|-------|------|----------|-------------|
| `run_id` | `RunId` | yes | Run identifier |
| `phase` | `PhaseName` | yes | Always `"pretranslation"` |
...
|-------|------|----------|-------------|
| `run_id` | `RunId` | yes | Run identifier |
| `phase` | `PhaseName` | yes | Always `"translate"` |
| `target_language` | `LanguageCode` | yes | Target language code |
...
|-------|------|----------|-------------|
| `run_id` | `RunId` | yes | Run identifier |
| `phase` | `PhaseName` | yes | Always `"edit"` |
| `target_language` | `LanguageCode` | yes | Target language code |
