---
description: Critique and score completed spec implementations across a 5-pronged rubric (Performance, Intent, Completion, Security, Stability) plus standards adherence.
---

# Audit Spec

Produces an audit.md file in the spec folder.
...
Use question only if clarification is needed:
...
For each action item, use question to present it with context:
...
2. Use question to ask which milestone:
   ```
...
1. Use question to capture the rationale:
   ```
