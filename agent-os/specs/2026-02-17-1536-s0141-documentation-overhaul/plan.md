...
- [ ] Task 4: Write Architecture overview
  ...
  - [ ] Fix: Correct artifact-index location in the storage model; `index.jsonl` is stored at `.rentl/artifacts/index.jsonl` (global), not `.rentl/artifacts/{run_id}/index.jsonl`. Evidence: `docs/architecture.md:231`, `packages/rentl-io/src/rentl_io/storage/filesystem.py:202`, `packages/rentl-io/src/rentl_io/storage/filesystem.py:512`. (audit round 2)
