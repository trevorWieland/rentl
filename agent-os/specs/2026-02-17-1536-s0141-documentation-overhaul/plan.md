...
- [ ] Task 3: Write Getting Started guide
  ...
  - [ ] Fix: Remove placeholder command examples that are not copy-pasteable (`uvx rentl export -i out/run-<run-id>/en.jsonl ...` and `uvx rentl run-phase --phase <phase>`) and replace with executable alternatives (`docs/getting-started.md:207`, `docs/getting-started.md:217`) (audit round 1)
