...
- [ ] Task 4: Core Help Content Module
  ...
  - [ ] Fix: Correct `run-pipeline` help metadata to match the real CLI flag (`--target-language` repeatable, not `--target-languages`) and update the example invocation (`packages/rentl-core/src/rentl_core/help.py:120`, `packages/rentl-core/src/rentl_core/help.py:124`, `services/rentl-cli/src/rentl_cli/main.py:163`, `services/rentl-cli/src/rentl_cli/main.py:504`) (audit round 1)
  - [ ] Fix: Add regression test coverage that fails if `run-pipeline` help advertises flags/examples not accepted by the CLI signature (`packages/rentl-core/tests/unit/core/test_help.py:148`, `services/rentl-cli/src/rentl_cli/main.py:163`, `services/rentl-cli/src/rentl_cli/main.py:504`) (audit round 1)
