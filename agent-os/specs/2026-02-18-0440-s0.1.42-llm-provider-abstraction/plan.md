...
- [ ] Task 10: Add mock-server integration test for local model factory path (demo runs 2-27, signpost #2)
  ...
  - [ ] Fix: Replace `object` in helper type annotations with explicit JSON/value types to satisfy `strict-typing-enforcement` (`tests/integration/byok/test_local_model_factory.py:44`, `tests/integration/byok/test_local_model_factory.py:76`, `tests/integration/byok/test_local_model_factory.py:78`) (audit round 1)
