...
- [ ] Task 3: Convert unit test assertions to schema validation
  ...
  - [ ] Fix: Replace remaining raw dict drilling on generated `rentl.toml` assertions with `RunConfig.model_validate` + attribute access in `tests/unit/cli/test_main.py:2036`, `tests/unit/cli/test_main.py:2071`, and `tests/unit/cli/test_main.py:2142` (audit round 2)
