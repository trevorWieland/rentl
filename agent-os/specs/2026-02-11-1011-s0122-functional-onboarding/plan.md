...
- [ ] Task 5: Add project README.md
  ...
  - [ ] Fix: Correct invalid Make target names in `README.md:153-155` (`make test-int`, `make test-all` do not exist) to match actual targets in `Makefile:67-103` (e.g., `make unit`, `make integration`, `make all`) so the README remains accurate (audit round 5)
