...
- **Impact:** Task 7 currently does not satisfy its core acceptance ("all phases complete successfully") because execution aborts at config resolution; future pipeline tests must keep all project paths within `workspace_dir`.
