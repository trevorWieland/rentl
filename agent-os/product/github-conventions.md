...
Canonical reference for GitHub issue format, labels, and dependency management across all agent-os commands. All commands that create or update issues MUST follow these conventions.
